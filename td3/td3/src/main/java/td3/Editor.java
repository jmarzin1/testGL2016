...
public class Editor {
    ...
    private IBuffer buffer;     // text buffer
    private IKillRing killring; // killring
    private int cursor, mark;   // cursor and mark position
    public boolean yankMode;   // true if yankpop can be called
    private int yankLeft, yankRight; // last section yanked

    ////////////////////////////////////////////////////////////////

    public Editor() {
        buffer = new Buffer("alea jacta est");
    ...
    public Editor(IBuffer buffer, IKillRing killRing) {
        this.buffer = buffer;
